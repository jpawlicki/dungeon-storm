abilityData.SWORD = new class extends Ability {
	constructor() {
		...
		this.details = [
			...
			"  The chance that the enemy !RETREATs is equal to their strength divided by the sum of their strength and this unit's strength.",
			"  If the enemy does not !RETREAT, this unit !RETREATs.",
